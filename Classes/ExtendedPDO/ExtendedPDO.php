 ...
 * by theWhK - 2018
 * ---------
 * Classe retirada de https://coderwall.com/p/rml5fa/nested-pdo-transactions
 * Acesso em 19 de Março de 2017, 12h44.
 * ---------
 * Fora implementada no projeto para permitir transações afilhadas.
 */

namespace Combine\Classes\ExtendedPDO;
