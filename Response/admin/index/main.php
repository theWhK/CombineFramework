...
<!--Morris Chart CSS -->
<link rel="stylesheet" href="<?=URL_BASE?>/response/admin/_includes/assets/plugins/morris/morris.css">
    </head>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="card-box widget-user">
                            <div>
                                <img src="<?=URL_BASE?>/Response/admin/template_base/assets/images/users/avatar-3.jpg" class="img-responsive img-circle"
                                     alt="user">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card-box widget-user">
                            <div>
                                <img src="<?=URL_BASE?>/Response/admin/template_base/assets/images/users/avatar-2.jpg" class="img-responsive img-circle"
                                     alt="user">
                                <div class="wid-u-info">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card-box widget-user">
                            <div>
                                <img src="<?=URL_BASE?>/response/admin/template_base/assets/images/users/avatar-1.jpg" class="img-responsive img-circle"
                                     alt="user">
                                <div class="wid-u-info">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card-box widget-user">
                            <div>
                                <img src="<?=URL_BASE?>/response/admin/template_base/assets/images/users/avatar-10.jpg" class="img-responsive img-circle"
                                     alt="user">
                                <div class="wid-u-info">
                            ...
                            <div class="inbox-widget nicescroll" style="height: 315px;">
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="<?=URL_BASE?>/response/admin/template_base/assets/images/users/avatar-1.jpg"
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="<?=URL_BASE?>/response/admin/template_base/assets/images/users/avatar-2.jpg"
                                                                         class="img-circle" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="<?=URL_BASE?>/response/admin/template_base/assets/images/users/avatar-3.jpg"
                                                                         class="img-circle" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="<?=URL_BASE?>/response/admin/template_base/assets/images/users/avatar-4.jpg"
                                                                         class="img-circle" alt=""></div>
                                ...
                                <a href="#">
                                    <div class="inbox-item">
                                        <div class="inbox-item-img"><img src="<?=URL_BASE?>/response/admin/template_base/assets/images/users/avatar-5.jpg"
                                                                         class="img-circle" alt=""></div>
                    ...
                    <ul class="list-group list-no-border user-list">
                        <li class="list-group-item">
                            <a href="#" class="user-list-item">
                                <div class="avatar">
                                    <img src="<?=URL_BASE?>/response/admin/template_base/assets/images/users/avatar-2.jpg" alt="">
                                </div>
                                <div class="user-desc">
                        ...
                        <li class="list-group-item active">
                            <a href="#" class="user-list-item">
                                <div class="avatar">
                                    <img src="<?=URL_BASE?>/response/admin/template_base/assets/images/users/avatar-3.jpg" alt="">
                                </div>
                                <div class="user-desc">
