<?php require PATH_ABS . '/Response/admin/_includes/php/head.php'; ?>
    ...
    <body>
        ...
        <div class="wrapper">
            <div class="container">
                <form role="form" method="post" action="<?=URL_BASE?>/<?=$this->core->action_urlName?>/<?=$this->commandArchive?>/comando-criar">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h4 class="page-title">Criar Comando</h4>
                        </div>
                    </div>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-horizontal" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input name="urlAmigavel" type="text" id="urlAmigavel" class="form-control <?php if (isset($data['flag']['urlAmigavel'])){echo 'parsley-error';} ?>" placeholder="URL Amigável" value="<?=$data['urlAmigavel']?>">
