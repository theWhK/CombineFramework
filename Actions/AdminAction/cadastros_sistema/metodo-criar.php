...
if (isset($_POST['submit'])) {
    // Valida o formulário
    $validate = $FirstMoldHierarchyModule->method_validateFormData();
    ...
    if ($validate == true) {
        // Cadastra
        $createStatus = $FirstMoldHierarchyModule->method_create();
        ...
        if ($createStatus == true) {
            ...
            }', 'now', URL_BASE.'/'.$this->core->action_urlName.'/'.$this->commandArchive.'/metodo-criar');
        }
    }
}
